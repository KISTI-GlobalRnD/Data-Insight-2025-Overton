(function () {
  ...
  const en = {
    ...
    "hero.lede2":
      "This English version is a <strong>web-only summary</strong>. The full report and detailed SI remain in Korean. The page is based on DOI-linked policy-document → scholarly-article citations observed in Overton, so it shows only the currently observable evidence-linkage structure.",
    "hero.actions.aria": "Quick links",
    "hero.cta.report": "Open Korean PDF",
    ...
    "monitor.cta.report": "Open Korean PDF",
    "explore.title": "Explore",
    "explore.lede": "Use the English pages as a short web summary. Use the Korean PDF and Korean SI for the complete text.",
    "explore.card.report.meta": "Full report · Korean",
    "explore.card.report.title": "Korean PDF",
    "explore.card.report.desc": "Complete narrative report, figure captions, interpretation, and extension tasks",
