(function () {
  ...
  const en = {
    ...
    "meta.description":
      "A concise English web-only summary of how DOI-linked policy documents cite scholarly research through the Overton × OpenAlex evidence map.",
    ...
    "hero.lede2":
      "This English version is a <strong>web-only summary</strong>. The complete report and detailed SI are provided in Korean. The page is based on DOI-linked policy-document → scholarly-article citations observed in Overton, so it shows only the currently observable evidence-linkage structure.",
    ...
    "hero.stat.inbound": "Inbound policy citations to Korean research concentrated in the top 3 policy-source channels",
    ...
    "story.korea.title": "Korean research enters policy through a different route.",
    "story.korea.body":
    ...
    "monitor.cta.next": "Open Next Questions Summary",
    "monitor.cta.next.href": "./SI/next_questions_en.html",
    "monitor.cta.report": "Open Korean Report (PDF)",
    "explore.title": "Use this summary",
    "explore.lede": "Use the English pages as a short web summary. The complete report and detailed SI are provided in Korean.",
    "explore.card.report.meta": "Complete report · Korean",
    "explore.card.report.title": "Korean Report (PDF)",
    "explore.card.report.desc": "Complete Korean report text, figure captions, and interpretation",
    "explore.card.si.meta": "English web summary · 3 min",
    "explore.card.si.title": "English Summary",
    "explore.card.si.desc": "Concise overview of the report message, scope, definitions, and next checks",
    "explore.card.si.href": "./SI/index_en.html",
    "explore.card.update.meta": "Web update",
    "explore.card.update.title": "2026 Update Summary",
    "explore.card.update.desc": "High-level comparison results from the newer data",
