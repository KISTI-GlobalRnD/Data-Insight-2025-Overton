(function () {
  ...
  const en = {
    ...
    "hero.cta.report": "View Main Report (Korean PDF)",
    ...
    "monitor.cta.report": "View Main Report (Korean PDF)",
    ...
    "explore.card.report.title": "Main Report (Korean PDF)",
    ...
    "footer.link.report": "Main Report (Korean PDF)",
